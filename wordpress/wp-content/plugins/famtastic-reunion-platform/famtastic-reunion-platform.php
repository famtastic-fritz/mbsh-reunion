...
define('FAMTASTIC_REUNION_VERSION', '0.5.0');
...
require_once __DIR__ . '/includes/class-commerce.php';
...
add_action('plugins_loaded', static function (): void {
    ...
    Famtastic_Reunion_Commerce::register();
...
register_activation_hook(__FILE__, static function (): void {
    ...
    Famtastic_Reunion_Commerce::ensure_schema();
...
register_deactivation_hook(__FILE__, static function (): void {
    ...
    if (function_exists('as_unschedule_all_actions')) {
        ...
        as_unschedule_all_actions('famtastic_reunion_order_attempt_monitor', [], 'famtastic-reunion');
        as_unschedule_all_actions('famtastic_reunion_send_paid_order_notice', [], 'famtastic-reunion');
    }
    wp_clear_scheduled_hook('famtastic_reunion_order_attempt_monitor');
    flush_rewrite_rules();
});
